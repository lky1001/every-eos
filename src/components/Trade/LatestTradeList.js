                    ...
                    latestTradesList.map((latestTrade, idx) => {
                      return (
                        <TableMdRow
                          ...
                          <DateColumn>
                            {`${new Date(Date.parse(latestTrade.created)).getMonth() +
                              1}-${new Date(Date.parse(latestTrade.created)).getDay() +
                              1} ${new Date(Date.parse(latestTrade.created)).toLocaleTimeString()}`}
                          </DateColumn>
                        </TableMdRow>
                      )
                    })}
